...
public class TestCases
{
   ...
   public void testSimpleIf3()
   {
      ...
      assertEquals(10.0, SimpleIf.max(10.0, 3.2), DELTA);
   }
   ...
   public void testSimpleArray3()
   {
      ...
      /* TO DO: Add a new test case. */
         assertArrayEquals(
         new int[] {1, 4},
         SimpleArray.squareAll(new int[] {1, 2}));
   }
   ...
   public void testSimpleList2()
   {
      ...
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {4, 9, 16}));
   ...
   public void testExampleMap2()
   {
      ...
      List<String> expected = Arrays.asList("Subal");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();
      ...
      courseListsByStudent.put("Julie",
         Arrays.asList(
            ...
            new Course("CPE 202", 4),
            new Course("CPE 225", 4)));
      courseListsByStudent.put("Subal",
         Arrays.asList(
            new Course("CPE 101", 4),
            new Course("CPE 202", 4),
            new Course("CPE 202", 4),
